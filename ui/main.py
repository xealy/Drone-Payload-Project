...
from dashboard.models import DataModel, ImageModel, MeasurementChart
...
@app.route('/target_detection', methods=['GET', 'POST'])
def target_detection():
    if request.method == 'POST':
        ...
        # return redirect(url_for('target_detection'))
    ...
    while True:
        ...
        if frame is not None:
            ...
            if currentTime - lastSavedTime >= 4:
                ...
                response = requests.post("http://10.88.12.134:5000/target_detection", json=data)
